 ...
 * @author M. Krone
 */
public class AlapoGetMovesTest extends ComparisonTest 
{
	/**
	 * Test f�r Ausgangssituation von Alapo
	 */
	@Test(timeout=1000)
	public void testInitGetMoves()
	{
		...
		{
			String pos = x + "1";
			assertEquals("getMoves(\"" + pos + "\") sollte leerer String sein, da kein Zug m�glich", "", board.getMoves(pos));
		...
		assertTrue("getMoves(\"A2\") liefert falsches Ergebnis", this.compareCaseSensitive("A2A3", board.getMoves("A2")));
		assertTrue("getMoves(\"B2\") liefert falsches Ergebnis", this.compareCaseSensitive("B2A3 B2C3", board.getMoves("B2")));
		...
		assertTrue("getMoves(\"E2\") liefert falsches Ergebnis", this.compareCaseSensitive("E2D3 E2F3", board.getMoves("E2")));
		assertTrue("getMoves(\"F2\") liefert falsches Ergebnis", this.compareCaseSensitive("F2F3", board.getMoves("F2")));

		
		assertTrue("getMoves(\"A5\") liefert falsches Ergebnis", this.compareCaseSensitive("A5A4", board.getMoves("A5")));
		assertTrue("getMoves(\"B5\") liefert falsches Ergebnis", this.compareCaseSensitive("B5A4 B5C4", board.getMoves("B5")));
		...
		assertTrue("getMoves(\"E5\") liefert falsches Ergebnis", this.compareCaseSensitive("E5D4 E5F4", board.getMoves("E5")));
		assertTrue("getMoves(\"F5\") liefert falsches Ergebnis", this.compareCaseSensitive("F5F4", board.getMoves("F5")));		
	}
