 ...
 * @author M. Krone
 */
public class HybridFinalMoveTest
{
	 ...
	 * 1: .. .. .. .. .. .. 
   	 ...
   	 *  SL schlägt WL -> FINAL (da weiss keine Figuren mehr besitzt)
	 */
	@Test(timeout=1000)
	public void testFinalMoveWeiss1()
	{
		...
		// Zug von schwarz
		assertEquals("E4C6 ist ein FINAL-Zug, da keine weissen Figuren mehr übrig sind", EStatus.FINAL, board.move("E4C6"));
	}
	 ...
	 * 1: .. .. .. .. .. .. 
   	 ...
   	 *  SL schlägt WL mit E3F4 *nicht* -> FINAL (Grundlinie erreicht)
	 */
	@Test(timeout=1000)
	 ...
	 * 1: .. .. .. .. .. .. 
   	 *    A  B  C  D  E  F 
   	 *    
   	 *  WT zieht C3 -> C4: LEGAL (diesen Zug machen wir nur, da weiss ja immer anfängt)
   	 *  SL zieht B2 -> C1: LEGAL
   	 *  WT zieht C4 -> C1 (Rettung): FINAL, da keine schwarze Figur mehr übrig 
	 */
	@Test(timeout=1000)
	public void testFinalMoveSchwarz1()
	{
		...
		// Zug von weiss
		assertEquals("C4C1 ist ein finaler Zug, da keine schwarze Figur mehr übrig ist", EStatus.FINAL, board.move("C4C1"));		
	}	
